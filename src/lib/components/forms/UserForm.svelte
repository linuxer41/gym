...
<FormLayer {title} on:confirm={async()=>{
    ...
    <form bind:this={form}>
        <h6 class="text-stale-400 text-sm mt-3 mb-6 font-bold uppercase">Informacion del usere</h6>
        <div class="flex flex-wrap">
            ...
            {#if !isEdit}
            <TextField label="Contraseña" bind:value={data.pass} placeholder="" type="password"  required />
            {/if}
