...
>
	<div class="overflow-auto w-2/3 h-full bg-white rounded-lg shadow-lg flex flex-col">
		<div
			class="rounded-t bg-white mb-0 px-6 py-6 sticky top-0 z-10 grid grid-cols-[auto_1fr_auto] text-center"
		>
			<!-- close icon -->
			<i
				class="fas fa-times text-slate-700 text-xl font-bold cursor-pointer"
		...
		<div class="flex-auto p-4 bg-slate-100">
			<slot />
		</div>
	</div>
</div>
