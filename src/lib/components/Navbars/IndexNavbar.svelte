<script>
	// core components
	import IndexDropdown from '$lib/components/Dropdowns/IndexDropdown.svelte';
...
>
	<div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
		<div class="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
			<a
				class="text-stale-700 text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase"
				href="/"
			>
				Notus Svelte
			</a>
		...
		>
			<ul class="flex flex-col lg:flex-row list-none mr-auto">
				<li class="flex items-center">
					...
					>
						<i class="text-stale-400 far fa-file-alt text-lg leading-lg mr-2" />
						Docs
					</a>
				</li>
			</ul>
			<ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
				...
				<li class="flex items-center">
					<a
						...
						target="_blank"
					>
						<i class="text-stale-400 fab fa-facebook text-lg leading-lg" />
				...
				<li class="flex items-center">
					<a
						...
						target="_blank"
					>
						<i class="text-stale-400 fab fa-twitter text-lg leading-lg" />
				...
				<li class="flex items-center">
					<a
						...
						target="_blank"
					>
						<i class="text-stale-400 fab fa-github text-lg leading-lg" />
